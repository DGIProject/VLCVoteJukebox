...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron">
                <form enctype="multipart/form-data" action="model/post_send.php" method="post" class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="file" class="form-control" id="inputFile" name="list"/>
                            </div>
                        </div>
                        <div class="form-group">
